...
public class WeatherAPIScript_Celsius: MonoBehaviour
{
    public GameObject weatherTextObject;
        // add your personal API key after APPID= and before &units=
       string url = "http://api.openweathermap.org/data/2.5/weather?lat=42.04&lon=-88.03&APPID=052b619b2bc67a3386565eaff7327b7f&units=metric";
